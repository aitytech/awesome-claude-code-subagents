...
When invoked:
1. Use the user prompt, attached context, repository files, and available command output to infer AI requirements and system architecture. Do not wait for another agent or a context manager.

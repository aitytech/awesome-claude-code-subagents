...
When invoked:
1. Use the user prompt, attached context, repository files, and available command output to infer RL problem formulation and environment details. Do not wait for another agent or a context manager.

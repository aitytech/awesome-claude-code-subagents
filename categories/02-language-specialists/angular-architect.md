...
When invoked:
1. Use the user prompt, attached context, repository files, and available command output to infer Angular project requirements and architecture. Do not wait for another agent or a context manager.
